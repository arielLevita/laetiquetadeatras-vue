...
<template>
  <header>
    ...
    <div class="container-fluid intro">
      <div class="wrapper">
        <div class="col-12 col-md-8 mx-auto py-3 pt-md-4 pb-md-5">
          <p class="px-md-4 m-0 text-dark">
            En este sitio vas a poder encontrar la información nutricional de productos de
            supermercado directamente desde sus etiquetas con el propósito de brindarte datos
            necesarios para tomar decisiones informadas sobre tu alimentación. Explorá la plataforma
            y descubrí cómo podés mejorar tu bienestar a través del conocimiento nutricional.
          </p>
        </div>
      </div>
    </div>
    ...
    <section>
      <div class="slider container-fluid py-2 py-md-3">
        <div class="wrapper">
          <div class="px-md-2">
            <div
              class="d-flex flex-column flex-md-row justify-content-center align-items-center flex-wrap"
            >
              <div class="p-3">
                <svg
